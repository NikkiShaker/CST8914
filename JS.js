...
// R.G. Here to add the roving tabindex logic  ;)
      if(newMenuitem.innerHTML == item.innerHTML)
      {
        // Set tabindex of the target item to 0, making it focusable
        item.setAttribute('tabindex', 0);

         // Set focus to the target item, allowing keyboard navigation to reach it
        item.focus();
      }
      else{
        // Set tabindex of the target item to -1, making it unfocusable
